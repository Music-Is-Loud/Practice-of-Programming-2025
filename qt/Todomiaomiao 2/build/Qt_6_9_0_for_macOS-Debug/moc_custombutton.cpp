...
#include "../../../Todomiaomiao_0509/custombutton.h"
...
void CustomButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CustomButton::*)(QString )>(_a, &CustomButton::editButtonClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CustomButton::*)(QString )>(_a, &CustomButton::mainButtonClicked, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (CustomButton::*)(QString )>(_a, &CustomButton::deleteButttonClicked, 2))
            return;
    }
}
