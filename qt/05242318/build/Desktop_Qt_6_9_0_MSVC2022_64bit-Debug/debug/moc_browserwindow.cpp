...
template <> constexpr inline auto BrowserWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13BrowserWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'injectOverlayButton'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleNewWindowRequest'
        QtMocHelpers::SlotData<void(QWebEngineNewWindowRequest &)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
    };
...
void BrowserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->injectOverlayButton(); break;
        case 2: _t->handleNewWindowRequest((*reinterpret_cast< std::add_pointer_t<QWebEngineNewWindowRequest&>>(_a[1]))); break;
        default: ;
        }
    }
}
