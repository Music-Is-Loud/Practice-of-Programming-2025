...
Todo::Todo(const QString &_name, const QDateTime &_baseTime, const QString &_details,
           const bool &_isCompleted, const int &_priority, const int &_todoId) : Event(_name, _baseTime, _details), isCompleted(_isCompleted), priority(_priority), todoId(_todoId) {};
