#ifndef SMALLCUSTOMBUTTON_H
#define SMALLCUSTOMBUTTON_H
...
class SmallCustomButton : public QWidget {
    Q_OBJECT

public:
    explicit SmallCustomButton(const QString &text, const QString &id, QWidget *parent = nullptr);
    QString id;
    QString title;
    QString info;
